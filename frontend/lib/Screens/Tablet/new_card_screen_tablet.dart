...
/// Obrazovka pre vytvorenie novej kartičky (flashcard) pre tabletove zariadenia.
///
...
class NewCardScreenTablet extends StatelessWidget {
  const NewCardScreenTablet({super.key});
                          ...
                          builder: (context, child) {
                            ...
                            return Transform(
                              ...
                              child: Container(
                                decoration: BoxDecoration(
                                  color:
                                      isBack ? backCardColor : frontCardColor,
                                  borderRadius: BorderRadius.circular(16),
                                ),
                                child: Stack(
                                  alignment: Alignment.center,
                    ...
                    children: [
                      ...
                      ElevatedButton(
                        onPressed:
                            _isCardFilled()
                                ? () async {
                                  final int? cardId = await ApiService()
                                      .saveCardToSet(
                                        setId: widget.setId,
                                        frontText: frontText,
                                        backText: backText,
