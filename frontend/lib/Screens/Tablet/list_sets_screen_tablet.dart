...
class ListOfSetsScreenTablet extends StatefulWidget {
  const ListOfSetsScreenTablet({Key? key}) : super(key: key);

  @override
  State<ListOfSetsScreenTablet> createState() => _ListOfSetsScreenState();
}

class _ListOfSetsScreenState extends State<ListOfSetsScreenTablet> {
  /// online / offline dáta
    ...
    return Scaffold(
      ...
      body: LayoutBuilder(
        builder: (context, constraints) {
          ...
          final crossAxisCount = (screenWidth ~/ 300).clamp(1, 3);
