...
/// Obrazovka pre úpravu existujúcej sady kartičiek v mobilnom rozhraní.
///
...
class EditSetScreenMobile extends StatefulWidget {
  final FlashcardSet flashcardSet;

  const EditSetScreenMobile({super.key, required this.flashcardSet});

  @override
  State<EditSetScreenMobile> createState() => _EditSetScreenState();
}

class _EditSetScreenState extends State<EditSetScreenMobile> {
