...
class EditCardScreenMobile extends StatefulWidget {
  final int flashcardId;

  const EditCardScreenMobile({super.key, required this.flashcardId});

  @override
  State<EditCardScreenMobile> createState() => _EditCardScreenState();
}

class _EditCardScreenState extends State<EditCardScreenMobile>
