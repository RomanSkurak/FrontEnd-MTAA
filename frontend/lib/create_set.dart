      ...
      body: SingleChildScrollView(
        ...
        child: Column(
          ...
          children: [
            ...
            // Add card button (s await + spätná hodnota)
            InkWell(
              onTap: () async {
                final result = await Navigator.pushNamed(context, '/newcard');

                if (result != null && result is String) {
                  setState(() {
                    cards.add(result); // pridáme kartu do zoznamu
                  });
                }
              },
        ...
        child: SizedBox(
          ...
          child: ElevatedButton(
            onPressed: () async {
              ...
              try {
                await ApiService().createSet(name: name, isPublic: false);
